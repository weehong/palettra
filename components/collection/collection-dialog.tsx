...
export function CollectionDialog({
  ...
  function handleOpen(palette: SavedPalette): void {
    const href = isSafePaletteHref(palette.href)
      ? palette.href
      : buildThemeHref(
          { roles: palette.roles },
          palette.typography ?? undefined,
        );
    router.push(href);
                ...
                >
                  <div className="flex flex-wrap items-start gap-3">
                    <div className="min-w-0 flex-1">
                      {renamingId === palette.id ? (
                        ...
                        >
                          ...
                          <Button
                            ...
                            className="min-w-16 px-3 font-semibold disabled:cursor-wait"
                          >
                      ...
                      <div className="mt-2 border-border flex overflow-hidden rounded-md border w-fit">
                        {palette.roles.slice(0, 6).map((role) => (
                          <span
                            key={role.id}
                  ...
                  <div className="flex flex-wrap justify-end gap-2">
                    ...
                    <Button
                      ...
                      disabled={deletingId === palette.id}
                      className="px-3 font-semibold disabled:cursor-wait"
                    >
                      Rename
                    </Button>
                    <Button
                      ...
                      className="text-destructive hover:text-destructive min-w-20 px-3 font-semibold disabled:cursor-wait"
                    >
